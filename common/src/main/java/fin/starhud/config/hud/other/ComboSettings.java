...
public class ComboSettings {
    ...
    public BaseHUDSettings base = new BaseHUDSettings(true, 0, -199, ScreenAlignmentX.CENTER, ScreenAlignmentY.BOTTOM, GrowthDirectionX.CENTER, GrowthDirectionY.UP);
