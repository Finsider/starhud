...
public class RenderUtils {
    ...
    public static boolean drawItemHUD(GuiGraphics context, FormattedCharSequence str, int x, int y, int width, int height, ItemStack itemAsIcon, int textColor, HUDDisplayMode displayMode, boolean drawBackground, boolean drawTextShadow) {
        ...
        switch (displayMode) {
            case ICON -> {
                ...
                context.renderItem(itemAsIcon, x + 3, y + 3);
            }
            case INFO -> {
                if (drawBackground)
                    fillRounded(context, x, y, x + width, y + height, 0x80000000);
    ...
    public static boolean drawItemHUD(GuiGraphics context, String str, int x, int y, int width, int height, ItemStack itemAsIcon, int textColor, HUDDisplayMode displayMode, boolean drawBackground, boolean drawTextShadow) {
    ...
    public static void fillRoundedLeftSide(GuiGraphics context, int x1, int y1, int x2, int y2, int color) {
        if (HUD_SETTINGS.drawBackgroundRounded) {
    ...
    public static void drawBorder(GuiGraphics context, int x, int y, int w, int h, int color) {
    ...
    public static void drawTextHUD(GuiGraphics context, FormattedCharSequence text, int x, int y, int color, boolean shadow) {
        context.drawString(CLIENT.font, text, x, y + HUD_SETTINGS.textYOffset, color, shadow);
    }
}
