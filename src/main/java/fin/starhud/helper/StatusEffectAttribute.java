...
public record StatusEffectAttribute(int maxDuration, int amplifier, boolean isAmbient) {
    ...
    private static final Map<StatusEffect, StatusEffectAttribute> STATUS_EFFECT_ATTRIBUTE_MAP = new HashMap<>();
    ...
    public static void removeStatusEffectAttribute(StatusEffect effectRegistry) {
    ...
    public static Map<StatusEffect, StatusEffectAttribute> getStatusEffectAttributeMap() {
