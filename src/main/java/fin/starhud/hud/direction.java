...
public class direction {
    ...
    public static void initDirectionConfiguration() {
        if (direction.includeOrdinal)
            x = Helper.calculatePositionX(base, width_ordinal);
        else
            x = Helper.calculatePositionX(base, width_cardinal);
